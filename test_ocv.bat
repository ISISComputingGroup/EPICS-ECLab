...
caput %MYPVPREFIX%ECLAB_01:C0:T:OCV:0:RTT:SP 300
caput %MYPVPREFIX%ECLAB_01:C0:T:OCV:0:REDE:SP 1
caput %MYPVPREFIX%ECLAB_01:C0:T:OCV:0:REDT:SP 0.5
...
caput %MYPVPREFIX%ECLAB_01:C0:T:OCV:0:XCTR:SP 0
...
caput %MYPVPREFIX%ECLAB_01:C0:LOADTECH:SP "ocv"
